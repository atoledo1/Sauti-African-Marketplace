...
return (
  ...
  <Panel header={props.item.product_name}  >
    <Card  title={`Seller:${seller[0].username}`} actions={[user.id === props.item.user_id && (<Button onClick={modifyItem}>Edit</Button>),user.id !== props.item.user_id &&  <Button>Buy</Button>]}>
